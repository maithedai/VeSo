...
class Theme(models.TransientModel):
    ...
    def onchange_name(self):
        theme = self.sudo().env.ref('odo_pharma_theme.theme_data_stored')
        if theme:
    ...
    def action_apply(self):
        ...
        if name == 'two':
            self.env.ref('odo_pharma_theme.vista_theme_css_black').active = False
            self.env.ref('odo_pharma_theme.vista_theme_css_login_black').active = False
            self.env.ref('odo_pharma_theme.vista_theme_css_green').active = True
            self.env.ref('odo_pharma_theme.vista_theme_css_login_green').active = True
            self.icon_change_theme_green()
        elif name == 'three':
            self.env.ref('odo_pharma_theme.vista_theme_css_green').active = False
            self.env.ref('odo_pharma_theme.vista_theme_css_login_green').active = False
            self.env.ref('odo_pharma_theme.vista_theme_css_black').active = True
            self.env.ref('odo_pharma_theme.vista_theme_css_login_black').active = True
        ...
        for menu in menu_item:
            if menu.name == 'Contacts':
                img_path = get_module_resource(
                    'odo_pharma_theme', 'static', 'src', 'img', 'icons',
                    'contacts.png')
    ...
    def icon_change_theme_green(self):
        ...
        for menu in menu_item:
            if menu.name == 'Contacts':
                img_path = get_module_resource(
                    'odo_pharma_theme', 'static', 'src', 'img',
                    'icons_green',
                    'contacts.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
